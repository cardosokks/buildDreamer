...
router.post(['/projects/:projectId/pages', '/pages'], async (req, res) => {
    try {
        ...
        // Upload to FTP
        try {
            await (0, ftp_1.uploadSinglePageToFTP)(page.project.name, page.slug, page.html, page.css, page.js, page.isHomepage, page.project.navbarHtml, page.project.footerHtml);
        }
        catch (ftpErr) {
...
router.put('/pages/:id', async (req, res) => {
    try {
        ...
        // FTP Upload on Save
        try {
            await (0, ftp_1.uploadSinglePageToFTP)(page.project.name, updatedPage.slug, updatedPage.html, updatedPage.css, updatedPage.js, updatedPage.isHomepage, page.project.navbarHtml, page.project.footerHtml);
        }
        catch (ftpErr) {
