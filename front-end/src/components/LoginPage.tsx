  ...
  return (
    <div className="min-h-screen w-full bg-[#05080e] text-slate-100 flex flex-col items-center justify-center p-6 relative overflow-hidden select-none">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute top-1/4 left-1/4 w-[600px] h-[600px] bg-pink-600/10 rounded-full blur-[160px] animate-pulse" />
        <div className="absolute bottom-1/4 right-1/4 w-[600px] h-[600px] bg-purple-600/10 rounded-full blur-[160px] animate-pulse" style={{ animationDuration: '8s' }} />
      ...
      <div className="w-full max-w-sm relative z-10 flex flex-col items-center">
        ...
        <div className="w-full mb-6 text-center">
          <h2 className="text-xl font-bold text-white tracking-tight">Entrar na sua conta</h2>
          <p className="text-xs text-slate-400 mt-1">Insira suas credenciais para gerenciar seus projetos</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="w-full space-y-4">
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-11 pr-4 py-3.5 bg-slate-900/50 border border-slate-800/80 rounded-2xl text-sm text-white placeholder-slate-600 focus:outline-none focus:border-pink-500 focus:ring-2 focus:ring-pink-500/20 transition-all backdrop-blur-md"
              />
            </div>
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-4 bg-gradient-to-r from-pink-600 via-rose-600 to-purple-600 hover:from-pink-500 hover:to-purple-500 text-white font-bold text-sm rounded-2xl shadow-xl shadow-pink-600/25 transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50 mt-3"
          >
            {loading ? (
              <>
        ...
        <div className="w-full mt-8 pt-6 border-t border-slate-900/80 text-center flex flex-col items-center gap-3">
          ...
          <div className="flex items-center gap-1.5 text-[11px] text-slate-500 mt-1">
            ...
            <span>Ambiente seguro com criptografia JWT</span>
          </div>
        </div>
