...
export const SettingsPage: React.FC = () => {
  ...
  const handleDownloadN8nWorkflow = () => {
    ...
    const codeAggregateNode = [
      ...
      "    if (start !== -1) {",
      "      const jsonCandidate = end > start ? cleanText.substring(start, end + 1) : cleanText.substring(start);",
